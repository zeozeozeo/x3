...
- Extensive LLM model selection (Kimi K3, GLM-5.3, Gemini 3.8, DeepSeek V4.1, etcetc)
...
- A toggleable jailbreak for models with thinking prefill `/persona jailbreak:{prompt,think}`
