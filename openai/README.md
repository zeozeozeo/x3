...
[![Go Reference](https://pkg.go.dev/badge/github.com/zeozeozeo/x3/openai.svg)](https://pkg.go.dev/github.com/zeozeozeo/x3/openai)
[![Go Report Card](https://goreportcard.com/badge/github.com/zeozeozeo/x3/openai)](https://goreportcard.com/report/github.com/zeozeozeo/x3/openai)
...
```
go get github.com/zeozeozeo/x3/openai
```
...
import (
	"context"
	"fmt"
	openai "github.com/zeozeozeo/x3/openai"
)
...
See also: https://pkg.go.dev/github.com/zeozeozeo/x3/openai#ClientConfig
...
import (
	...
	"github.com/zeozeozeo/x3/openai"
	"github.com/zeozeozeo/x3/openai/jsonschema"
)
...
**Related Issues:**  
[omitempty option of request struct will generate incorrect request when parameter is 0.](https://github.com/zeozeozeo/x3/openai/issues/9)
...
**Related Issues:**  
[Is it possible to join the implementation of GPT3 Tokenizer](https://github.com/zeozeozeo/x3/openai/issues/62)

## Contributing

By following [Contributing Guidelines](https://github.com/zeozeozeo/x3/openai/blob/master/CONTRIBUTING.md), we hope to ensure that your contributions are made smoothly and efficiently.

## Thank you

We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/zeozeozeo/x3/openai/graphs/contributors) and sponsors of this project:
